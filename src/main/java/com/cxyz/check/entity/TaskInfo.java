...
public class TaskInfo{
	...
	public String toString() {
		return "TaskInfo [_id=" + _id + ", _name=" + _name + ", sponser=" + sponser + ", checker=" + checker
				+ ", start=" + start + ", end=" + end + ", classRoom=" + classRoom + ", type=" + type + ", grade="
				+ grade + ", completion=" + completion + ", dates=" + Arrays.toString(dates) + "]";
	}
